...
public class chap18_no31 {
    public static void emain(String[] args) {
        if (args.length < 3) {
            System.err.println("Usage: java Exercise18_30 dirName oldWord newWord");
            System.exit(0);
        }
    ...
    public static void main(String[] args) {
        String[] replace = {"C:\\Users\\Ella\\Desktop\\Test for 18.31", "I","nakakapagod"};
        emain(replace);
    }
}