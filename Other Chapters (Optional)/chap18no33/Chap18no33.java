...
public class Chap18no33 extends Application {
    ...
    private class Board extends Pane {
        ...
        File file = new File("C:\\Users\\Ella\\Desktop\\PROG\\Other Chapters\\src\\c18n33\\knight.jpg");
        ImageView theKnight = new ImageView(file.toURI().toString());
        
        File filee = new File("C:\\Users\\Ella\\Desktop\\PROG\\Other Chapters\\src\\c18n33\\knight.jpg");
        ImageView movingKnight = new ImageView(filee.toURI().toString());
        ...
        protected void draw() {
            ...
            movingKnight.setX(startX * getWidth() / SIZE);
            movingKnight.setY(startY * getHeight() / SIZE);
            movingKnight.setFitWidth(getWidth() / SIZE);
            movingKnight.setFitHeight(getHeight() / SIZE);
